...
public class WordDatabase {
	...
	public WordDatabase() {
		...
		words.add(new Word("APEL", "buah"));
		words.add(new Word("JERUK", "buah"));
		words.add(new Word("PISANG", "buah"));
		words.add(new Word("SEMANGKA", "buah"));
		words.add(new Word("PEPAYA", "buah"));
		words.add(new Word("JAMBU", "buah"));
		words.add(new Word("MANGGA", "buah"));
		words.add(new Word("RAMBUTAN", "buah"));
		words.add(new Word("DURIAN", "buah"));
		words.add(new Word("MELON", "buah"));
		words.add(new Word("SALAK", "buah"));
		words.add(new Word("NANAS", "buah"));
		words.add(new Word("TOMAT", "buah"));
		words.add(new Word("CABAI", "buah"));
		words.add(new Word("TERUNG", "buah"));
		
		words.add(new Word("KUBIS", "sayuran"));
		words.add(new Word("WORTEL", "sayuran"));
		words.add(new Word("SELADA", "sayuran"));
		words.add(new Word("ASPARAGUS", "sayuran"));
		words.add(new Word("BROKOLI", "sayuran"));
		words.add(new Word("SELEDRI", "sayuran"));
		words.add(new Word("SAWI", "sayuran"));
		words.add(new Word("BAYAM", "sayuran"));
		words.add(new Word("BAWANG MERAH", "sayuran"));
		words.add(new Word("BAWANG PUTIH", "sayuran"));
		words.add(new Word("BAWANG BOMBAI", "sayuran"));
		words.add(new Word("DAUN BAWANG", "sayuran"));
		words.add(new Word("BAWANG MERAH", "sayuran"));
		words.add(new Word("JAMUR", "sayuran"));
		words.add(new Word("JAGUNG", "sayuran"));
		words.add(new Word("LOBAK", "sayuran"));
		words.add(new Word("KENTANG", "sayuran"));
